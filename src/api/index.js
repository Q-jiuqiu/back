...
export function getList(params, page) {
  return request({
    url: `/dbs/pro/rest/dbs/find/${page.pageIndex}/${page.pageSize}`,
    method: "get",
    params
  });
}
...
export function delShop(id) {
  return request({
    url: `/dbs/pro/rest/dbs/delete/${id}`,
    method: "delete"
  });
}
...
export function postCommentAdd(params) {
  return request({
    url: `/dbs/pro/rest/dbs/add/comment`,
    method: "post",
    data: params
  });
}
...
export function postEscapeAdd(params) {
  return request({
    url: `/dbs/pro/rest/dbs/add/escape/pit`,
    method: "post",
    data: params
  });
}
...
export function getEscapeList(page) {
  return request({
    url: `/dbs/pro/rest/dbs/find/escape/pit/${page.pageIndex}/${page.pageSize}`,
    method: "get"
  });
}
// 删除避坑信息
export function deleteEscapeShop(id) {
  return request({
    url: `/dbs/pro/rest/dbs/delete/escape/pit/${id}`,
    method: "delete"
  });
}
// 获取留言数据列表
export function getFindLeaveList(page) {
  return request({
    url: `/dbs/pro/rest/dbs/find/leave/word/${page.pageIndex}/${page.pageSize}`,
    method: "get"
  });
}
// 删除留言信息
export function deleteEscapePit(id) {
  return request({
    url: `/dbs/pro/rest/dbs/delete/leave/word/${id}`,
    method: "delete"
  });
}
// 获取数据字典数据列表
...
export function deleteDictPit(id) {
  return request({
    url: `/dbs/pro/rest/dbs/delete/dict/${id}`,
    method: "delete"
  });
}
// 编辑数据字典数据
export function postDictEdit(params) {
  return request({
    url: `/dbs/pro/rest/dbs/edit/dict`,
    method: "post",
    data: params
  });
}
...
export function getTypeFind(type) {
  return request({
    url: `/dbs/pro/rest/dbs/find/type/v2/${type}`,
    method: "get"
  });
}
// 新增推荐
export function postRecommendAdd(params) {
  return request({
    url: `/dbs/pro/rest/dbs/add/recommend`,
    method: "post",
    data: params
  });
}
...
export function getRecommendFind(proId) {
  return request({
    url: `/dbs/pro/rest/dbs/find/recommend/${proId}`,
    method: "get"
  });
}
// 编辑推荐描述
export function postRecommendEdit(params) {
  return request({
    url: `/dbs/pro/rest/dbs/edit/recommend`,
    method: "post",
    data: params
  });
}
...
export function deleteRecommend(id) {
  return request({
    url: `/dbs/pro/rest/dbs/delete/recommend/${id}`,
    method: "delete"
  });
}
// 查询推荐描述
export function getTypeCityFind() {
  return request({
    url: `/dbs/pro/rest/dbs/find/type/v2`,
    method: "get"
  });
}
...
export function postCityDict(params) {
  return request({
    url: `/dbs/pro/rest/dbs/city/dict/add`,
    method: "post",
    data: params
  });
}
...
export function getCityFind(city) {
  return request({
    url: `/dbs/pro/rest/dbs/city/dict/find/${city}`,
    method: "get"
  });
}
// 查询城市分页
...
export function deleteCityDict(id) {
  return request({
    url: `/dbs/pro/rest/dbs/city/dict/delete/${id}`,
    method: "delete"
  });
}
// 编辑城市管理
export function postCityEdit(params) {
  return request({
    url: `/dbs/pro/rest/dbs/city/dict/edit`,
    method: "post",
    data: params
  });
}
...
export function getCommentById({ id, pageIndex, pageSize }) {
  return request({
    url: `/dbs/pro/rest/dbs/find/comment/${id}/${pageIndex}/${pageSize}`,
    method: "get"
  });
}
// 删除评价
export function deleteComment(id) {
  return request({
    url: `/dbs/pro/rest/dbs/delete/comment/${id}`,
    method: "delete"
  });
}
...
export function getRestFindExp(productId) {
  return request({
    url: `/dbs/pro/rest/dbs/exp/find/${productId}`,
    method: "get"
  });
}
// 新增探店
...
export function deleteExp(id) {
  return request({
    url: `/dbs/pro/rest/dbs/exp/del/${id}`,
    method: "delete"
  });
}
// 新增票价
export function postDbsFaresAdd(params) {
  return request({
    url: `/dbs/pro/rest/dbs/fares/add`,
    method: "post",
    data: params
  });
}
...
export function getFaresFindExp(productId) {
  return request({
    url: `/dbs/pro/rest/dbs/fares/find/${productId}`,
    method: "get"
  });
}
// 删除评价
export function deleteFares(id) {
  return request({
    url: `/dbs/pro/rest/dbs/fares/del/${id}`,
    method: "delete"
  });
}
...
export function getExpUserAdd(params) {
  return request({
    url: `/dbs/pro/rest/dbs/expUser/add`,
    method: "post",
    data: params
  });
}
...
export function postFaresFinExp(params) {
  return request({
    url: `/dbs/pro/rest/dbs/fares/find`,
    method: "post",
    data: params
  });
}
...
export function deleteExpUserDel(id) {
  return request({
    url: `/dbs/pro/rest/dbs/expUser/del/${id}`,
    method: "delete"
  });
}
// 查询主播
export function getExpUserFind({ pageIndex, pageSize }) {
  return request({
    url: `/dbs/pro/rest/dbs/expUser/find/${pageSize}/${pageIndex}`,
    method: "get"
  });
}
